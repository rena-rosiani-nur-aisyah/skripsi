        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="/test">Syarat Istihadhah</a></div>
                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Syarat Istihadhah</h4>
                                <div class="card-header-action">
                                    <a href="{{ url('tsnkisthdh') }}" class="btn active">+ Tambah
                                        Syarat Istihadhah</a>
                                </div>
                            </div>
                            <div class="card-body">

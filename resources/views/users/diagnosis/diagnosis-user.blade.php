                ...
                <section>
                    <div class="container py-4">
                        <div class="row">
                            ...
                            @else
                            <form action="{{ route('diagnosisUser') }}" method="get" enctype="multipart/form-data">
                                @csrf
                                ...
                                <center>
                                    <div class="buttons mt-5">
                                        ...
                                        <button class="btn btn-primary col-sm-2 mt-2" value="no"
                                            name="answer" type="submit">Tidak</button>
                                        <button class="btn btn-primary col-sm-2 mt-2" value="yes"
                                            name="answer" type="submit">Ya</button>
                                    </div>
                                </center>
                            </form>
                            @endif
